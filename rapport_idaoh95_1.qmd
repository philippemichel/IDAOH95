...
par(cex = 0.6)
radarchart(aa, title = "Principales missions d’une IPA au sein de votre structure", pcol = colx, , plwd =2, plty = 1)
legend(
...
levels(zz$Rôle) <- c("Il vous est déjà arrivé de déléguer en totalité", "Il vous est déjà arrivé de déléguer partiellement","Vous souhaitez déléguer mais vous ne le faites pas","Vous ne souhaiteriez pas déléguer cette mission", "Mission qui vous semble obsolète")

zz |> 
  ggplot() +
  aes(x = Rôle, fill = Rôle) +
  geom_bar(stat = "count") +
...
*Évaluer la connaissance du métier d’\gls{ipa} au sein des Ehpad*
...
#| tbl-cap: Évaluer la connaissance du métier d’\gls{ipa} au sein des Ehpad
