...
*Identifier le rôle effectif des IDEC*
...
zz <- idec |> 
  ...
  dplyr::select(- idec11)
var_label(zz$idec1) <- "Item premier cité"
```
...
```{r}
#| label: tbl-idec-cinq
#| tbl-cap: Rôle effectif des IDEC (5 premiers items cités)
...
*Évaluer la connaissance du métier d’IPA au sein des Ehpad*

Les réponses des directeurs & des médecins coordonateurs sont très proches & souvent complètement opposées à celles des IDEC.
...
#| tbl-cap: Évaluer la connaissance du métier d’IPA au sein des Ehpad*
